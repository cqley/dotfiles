...

{
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      animation({ leaf = "global", enabled = false, speed = 5, bezier = "default" })
      animation({ leaf = "border", enabled = false, speed = 2.5, bezier = "easeOutQuint" })
      animation({ leaf = "windows", enabled = false, speed = 2.5, bezier = "easeOutQuint" })
      animation({ leaf = "windowsIn", enabled = false, speed = 2, bezier = "easeOutQuint", style = "popin 90%" })
      animation({ leaf = "windowsOut", enabled = false, speed = 1, bezier = "linear", style = "popin 90%" })
      animation({ leaf = "fadeIn", enabled = false, speed = 1, bezier = "almostLinear" })
      animation({ leaf = "fadeOut", enabled = false, speed = 1, bezier = "almostLinear" })
      animation({ leaf = "fade", enabled = false, speed = 1.5, bezier = "quick" })
      animation({ leaf = "layers", enabled = false, speed = 2, bezier = "easeOutQuint" })
      animation({ leaf = "layersIn", enabled = false, speed = 2, bezier = "easeOutQuint", style = "fade" })
      animation({ leaf = "layersOut", enabled = false, speed = 1, bezier = "linear", style = "fade" })
      animation({ leaf = "workspaces", enabled = false, speed = 5, bezier = "hard", style = "slidevert" })
      animation({ leaf = "specialWorkspace", enabled = false, speed = 5, bezier = "hard", style = "slidevert" })
